...
- Loads learned rules from `.agents/kyro/rules.md`
...
- Auto-captures identified learnings into `.agents/kyro/rules.md`
...
- Updates `.agents/kyro/rules.md` with confirmed rules
...
- References the specific rule from `.agents/kyro/rules.md`
...
```json
{
  ...
  "self_correction": {
    "enabled": true,
    "require_approval": true,
    "learned_file": ".agents/kyro/rules.md"
  }
}
```
