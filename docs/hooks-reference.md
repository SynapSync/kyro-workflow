...
- Loads learned rules from `~/.kyro/rules.md`
...
- Auto-captures identified learnings into `~/.kyro/rules.md`
...
- Updates `~/.kyro/rules.md` with confirmed rules
...
- References the specific rule from `~/.kyro/rules.md`
