...
This is where all kyro documents for this project live. All file paths below are relative to this directory.
...
Then use /kyro to generate Sprint 1. Follow the roadmap's Sprint 1 definition
...
Then use /kyro to generate Sprint {N}. Ensure all recommendations from Sprint {N-1}
...
Then use /kyro to execute Sprint {N}. Work through each phase and task,
...
Then use /kyro to generate a status report showing: completed sprints,
