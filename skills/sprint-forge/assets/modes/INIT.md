...
- No previous kyro work for this project (if resuming, use SPRINT or STATUS mode)
...
> "Where should I save kyro documents for **{project_name}**?
>
> 1. **Default** (Recommended) — `.agents/kyro/{project-name}/`
...
**Next Step**: Generate Sprint 1 using `/kyro` or copy the re-entry prompt from RE-ENTRY-PROMPTS.md → Scenario 1.
```
