...
Load estimation rules from `~/.sprint-forge/rules.md` before producing any estimate.
...
- The `sprint-metrics` skill aggregates these across sprints for trend detection.
