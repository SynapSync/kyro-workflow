...
- Learnings from the retro are written to `LEARNED.md` and to `.agents/kyro-workflow/rules.md` for per-project reuse.
...
2. Write a re-entry prompt to `.agents/kyro-workflow/sprint-forge/{project}/reentry.md` that contains:
