...
## Scenario 2: Generate Sprint 4

Use to generate Sprint 4 (hook hardening + debug mode):

> I'm continuing the **kyro-workflow self-audit** project. Sprints 1-3 are complete.
>
...
> 3. `/Users/rperaza/joicodev/owned/synap-sync/kyro-workspace/.agents/kyro-workflow/sprint-forge/kyro-workflow/sprints/SPRINT-03-version-sync-manifests.md` (retro + recommendations + debt table)
> 4. `/Users/rperaza/joicodev/owned/synap-sync/kyro-workspace/.agents/kyro-workflow/sprint-forge/kyro-workflow/findings/11-silent-failure-pattern.md`
> 5. `/Users/rperaza/joicodev/owned/synap-sync/kyro-workspace/.agents/kyro-workflow/sprint-forge/kyro-workflow/findings/12-missing-validation-active-session.md`
>
> Then generate Sprint 4 using `/kyro-workflow:sprint generate`.
> Sprint 4 focuses on hardening hook scripts: KYRO_DEBUG env var, atomic writes, JSON validation.
